...
## Project Structure
    ...
    ├── testapiautosettings_89555  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_89555`
...
2. Clone this repo and `cd testapiautosettings_89555`
